...
*/ 
        ...
        .addField("Fun Commands", ['\`!meme - Sends meme\`', '\`!quote - Sends quote\`', '\`!coinflip - Play game coinflip\`', '\`!reverse - Reverse a word\`', '\`!roll - Roll a dice\`', '\`!8ball - Plays 8ball game\`', '\`!howgay - Roll a dice\`'], false)
